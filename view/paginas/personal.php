...
<section class="contenedor contenedor-personal mt-5">
    <div class="contenido-personal">
        <h2> Francisco AREESC </h2>
        <p>Francisco Arenas es un dentista amable y profesional. Siempre atento, se asegura de que sus pacientes se sientan cómodos y bien cuidados en cada visita. </p>
    </div>
</section>
